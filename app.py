...
def webhook_leads_pv():
    ...
    if request.headers['Content-Type'] == 'application/json':
        ...
        clientInterests = {
            'André': [67,68,21,58,71,89,18,28,36,37,41,45,8,10,51,52,25,39,70,90,77,78,91,92,93,94,95,19,23,87,54,55,57,88,59,62,14,50,61,27,76,44,49,53,72,85,60,80,16,17,79,86,11,48,22,35,56,9,31,32,46,65,81,82,1,7,26,38,42,83,84,60],
            ...
            'Yoel AM' : [31, 81, 82, 44, 49, 53, 72],
            'Yoel SZ': [01,38,73,74,44,49,53,72],
            'Yoel BJ1': [25,39,52,54,55,57,67,68,70,88,90],
            'Yoel BJ': [62, 61, 50, 72, 14, 51, 08,  27, 28, 76, 57,54,68,67,88],            
