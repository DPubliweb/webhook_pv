...
clientInterests = {
            'André': [56,22,35,14,61,53,72,49,44,85,79,86,16,17,87,23,18,36,41,45,28,37,27,76,80,2,60,55,54,57,88,68,67,70,90,25,39,71,21,89,58,42,1,38,26,7,84,82,81,31,32,65,9,66,11,48,63,43,12,46,47,30,8,51,10,52,15,19,3],
            'Yoel A': [44,49,72,53,85,17,79,43,48,12],
            'Yoel N' : [67,68,88,54,57,55,52,70,25,21],
            #'Yoel NG': [3,42,43,63],
            'Dan Amsellem': [45,28,89,51,10,27,61],
            'Daniel Zerdoun' : [54,55,57,67,68,88],
            #'Laurent Berdugo ': [54,55,57,51,10,52,],
            'Benjamin Bohbot': [3,16,19,22,23,35,36,37,53,56,70,71,72,86,87],
