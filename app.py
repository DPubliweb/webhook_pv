...
clientInterests = {
            'André': [24,33,40,47,43,3,63,15,21,71,89,58,22,29,35,56,18,28,36,41,45,37,8,10,51,52,39,25,70,90,48,19,23,87,54,55,57,88,9,12,31,32,46,81,82,59,62,14,50,61,27,76,44,49,53,72,85,2,60,80,16,17,79,86,1,26,38,7,42,67,68,64,65,30,34,73],
            'Yoel A': [42,26,1,38,33],
            #'Yoel SE' : [12,46,64,65],
            'David Madar': [61,72,62,59,80,2],
            #'Mickael Oiknine': [27,28,61],
            'Yoel YE' : [31,81,82,47,12],
            #'Laurent Berdugo ': [54,55,57,51,10,52,],
            #'Benjamin Bohbot': [16,19,22,23,25,35,36,53,56,70,71,72,86,87],
            #'Dorian Lancry 2': [59,62,60,80,2,27,28,76,45,89,8,10,51,77,78,91],
            ...
            #'Samuel Labiod': [22,29,56,35,14,50],
            ...
            'Yoel YE 2': [12,46,59,62,47],
            'Gary Cohen': [6,30,34,38,69], 
            'Samy Nackache RKBH': [72,53,37,41,86,44,49,85,79,35],
            'Yoel A5': [55,54,88,57,36,37,41,18,28,27],
            'Samy SO': [59,62,80,60,2],
            'Yoel MB': [14,28,45,72,89],
            'Yoel A2': [33,24,47,40,38],
            'Yoel A3': [44,35,85,37,41,53,72,86,49,79],
            'Yoel A4 ' : [61,14,50,52,35,72],
            'Samy Nackache NAKISS': [54,55,57,70,88],
            'Axel Zarka' : [14,16,17,19,50,76,87,12,17,32,85,87,23,19,63,3,42,43,15],
        }
