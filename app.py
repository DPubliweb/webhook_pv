...
# ============================================================
clientInterests = {
    #"André": [27,76,35,24,33,40,47,21,58,71,89,18,28,36,37,41,45,19,23,87,48,25,39,70,90,8,10,51,52,54,55,57,88,12,32,46,81,82,59,62,14,61,44,49,53,72,85,2,60,80,16,17,79,86,7,26,38,1,69,42,4,84,67,56],
    'David Madar': [27,28,45,60,80,59,62,72,61,2,76,1,3,42,71],
    'Gary Cohen': [38,69,06,83,30,34],
    'Axel Zarka':[14,50,27,76,28,54,57],
    'Ethan Baruk':[8,10,51,52,54,55,57,88,89],
