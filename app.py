...
clientInterests = {
            #'David Madar': [2,27,28,45,59,60,62,80],
            #'Gary Cohen': [6,30,34,38,69], 
            'André': [81,82,67,68,24,33,40,47,3,15,43,63,21,58,71,89,22,29,35,56,18,19,23,87,30,48,12,46,42,1,26,7,39,25,70,88,54,57,90,52,55,8,51,10,2,59,80,62,60,76,27,14,50,61,72,53,49,44,85,37,36,41,28,45,86,79,16,17,32,84,4,83,34,11,66,9,31,65,38,69,64],
            #'Samy ECO 1': [76,27,28,61,45,41,89,37,72],
            #'Yoel greenberg RD': [51,54,55,52,57,70,68,88,25],
            #'Yoel greenberg SE': [64,65,32,12,46,15],
            #'Yoel greenberg MB': [46,82,12,81],
            #'Jayson Partouche': [79,49,85], 
            #'Yoel greenberg RE': [21,58,71], 
            #'Yoel greenberg RD': [51,54,55,52,57,70,68,88,25 ], 
            #'Yoel greenberg RC': [14,50,76,53,72,11,66,34,31,81],
            #'Yoel greenberg HS': [19,23,87],  
            #'Samy ECO 2': [80,60,2,59,62,10,51],
            #'Samy LEV': [54,55,57,70,88,67,68,90],
            #'Samy GLC': [24,87,19,23,16,86],
            #'Samy KR': [70,39,25],
