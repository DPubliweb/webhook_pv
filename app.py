...
def webhook_leads_pv():
    ...
    if request.headers['Content-Type'] == 'application/json':
        ...
        clientInterests = {
            'André': [67,68,58,89,18,28,36,37,41,45,8,10,51,52,25,39,70,90,77,78,91,92,93,94,95,19,23,87,54,55,57,88,59,62,14,50,61,27,76,44,49,53,72,85,16,17,79,86,11,48,22,35,56,9,31,32,46,65,81,82,1,42,83,60],
            ...
            'Yoel AM' : [54, 57, 67, 68, 88, 44, 49,53,72],
            #'Yoel SZ': [1,38,73,74,44,49,53,72],
            #'Yoel BJ1': [25,39,52,54,55,57,67,68,70,88,90],
            'Yoel BJ': [62, 61, 50, 72, 14, 51, 8,  27, 28, 76, 57,54,68,67,88],            
            'Dan Amsellem': [35,22,56,29],
            #'Ruben Nadjar' : [21,71,58,70,25,27,76,11,66,26,64,65],
            'Laurent Berdugo Z1': [49, 44, 72, 53, 28, 41, 37, 61, 35, 79, 85, 86],
            #'Laurent Berdugo Z2': [33,16,17,24,40,47,31],            
