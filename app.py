...
def webhook_leads_pv():
    ...
    if request.headers['Content-Type'] == 'application/json':
        ...
        clientInterests = {
            'André': [54,57,55,88,67,68,25,70,90,31,32,9,81,82,30,34,79,86,85,63,33,20,77,78,92,91,93,94,95,8,10,51,52,62,59,61,3,15,19,46,12,37,41,36,18,21,28,45,65,11,66],
            ...
            'Zak Sebban': [1,2,10,18,21,22,24,25,27,29,33,35,36,37,38,39,41,42,44,47,49,50,51,52,54,55,56,57,60,67,68,69,70,71,73,74,76,77,78,79,80,85,88,89,90,91]
        }
