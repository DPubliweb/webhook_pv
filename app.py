...
clientInterests = {
            'André': [56,22,35,14,61,53,72,49,44,85,79,86,16,17,87,23,18,36,41,45,28,37,27,76,80,2,60,55,54,57,88,68,67,70,90,25,39,71,21,89,58,42,1,38,26,7,84,82,81,31,32,65,9,66,11,48,63,43,12,46,47,30,8,51,10,52,15,19],
            #'Yoel A': [41,36,37,89,21,71],
            'Yoel N' : [67,68,88,54,57,55,52,70,25,21],
            #'Yoel NG': [3,42,43,63],
            'Dan Amsellem': [28,45,89,10,51,61,72,27],
            ...
            'Yoel A2': [44,49,72,53,85,17,79,43,48,12],
            #'Mickael Perez': [44,49,59,80,62,60,77,78,91,92,93,94,95],
            'Samy Naccache GB': [44,49,85],
            'Samy Nackache YP': [87,19,23,31,31,82,9,11,15]
