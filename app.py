...
clientInterests = {
            'André': [29,22,56,35,67,68,24,33,40,47,64,3,43,63,21,58,71,89,18,28,36,37,41,45,8,10,51,52,25,39,70,90,48,19,23,87,54,55,57,88,12,46,82,81,42,69,1,38,26,7,2,60,80,76,27,14,61,50,53,72,49,44,85,79,86,16,17,59,62],

            'Yoel A': [14,59,62,36,37,76,18,45,50,55,61,88],
            #'Yoel N' : [67,68,88,54,57,55,52,70,25,21],
            #'David Madar': [80,60,2,59,62,27,28,45],
            'Dan Amsellem': [28,45,89,10,51,27],
            ...
            #'Samy Nackache ECO': [80,2,8,51,10,89,27,28,45,60,67,68,88,57,54,55,33,40],
            #'Samy Nackache SAV': [60,80,2],
            #'Samy Naccache SAV 2' : [87,19,23],
            #'Samy Nackache CIZ': [29,22,56],
        }
