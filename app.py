...
# ============================================================
clientInterests = {
    "André": [67,68,24,33,40,47,64,3,15,43,63,21,58,71,89,22,29,35,56,18,28,36,37,41,45,19,23,87,11,30,34,48,66,25,39,70,8,10,51,52,54,55,57,88,9,12,32,46,65,81,82,59,62,14,50,61,27,76,44,49,53,72,85,2,60,80,1,7,26,38,69,73,74,4,5,83,84,16,17,79,86],
    #'David Madar': [27,28,45,60,80,59,62,72,61,2,76,1,3,42,71],
    #'Gary Cohen': [6,30,34,38,69,83],
    #'Axel Zarka':[14,50,27,76,28],
    #'Ethan Baruk':[8,10,51,52,54,55,57,67,68,88,89],
    #'Reb 1': [33,47,87,23,19,46,24,16,17],
    #'Reb 2': [36,18,89,58,54,57,55,52,88],
    'Yanis Tatou': [81,82,11,31]
