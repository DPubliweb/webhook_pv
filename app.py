...
def webhook_leads_pv():
    ...
    if request.headers['Content-Type'] == 'application/json':
        ...
        clientInterests = {
            'André': [ 8, 10, 51, 52, 54, 55, 57, 67, 68, 88,1, 3, 7, 15, 26, 38, 63,21, 25, 39, 58, 70, 71, 89, 90,22, 29, 35, 56,18,28,36,37,41,45,2,59,60,62,80,77,78,91,92,93,94,95,14,27,50,61,76,16,17,19,23,33,64,79,86,87,9,11,30,31,32,34,65,66,81,82,44,49,53,72,85,13,83,84],
            ...
            'Laurent Berdugo': [44,49,53,72,60,80,18,36,2],
