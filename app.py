...
def webhook_leads_pv():
    ...
    if request.headers['Content-Type'] == 'application/json':
        ...
        clientInterests = {
            'André': [ 3,63,21,58,71,89,22,35,18,28,36,37,41,45,19,23,87,25,70,90,54,57,88,14,50,61,27,76,44,49,53,72,85,2,60,80,1,7,26,38,16,17,79,86,84,46,12,68,67,55,15,43,42],
