...
clientInterests = {
            'André': [24,33,40,47,43,3,63,15,21,71,89,58,22,29,35,56,18,28,36,41,45,37,8,10,51,52,39,25,70,90,48,19,23,87,54,55,57,88,9,12,31,32,46,81,82,59,62,14,50,61,27,76,44,49,53,72,85,2,60,80,16,17,79,86,1,26,38,7,42,67,68,64,65],
            'Yoel A': [42,26,1,38],
            'Yoel SE' : [12,46,64,65],
            'David Madar': [61,72,62,59,80,2],
            'Mickael Oiknine': [27,28,61],
            'Yoel YE' : [59,62,31,81,82,47,22,56,36],
            ...
            'Yoel A2': [55,54,57,88,14,76,50,61],
            'Yoel A3': [53,35,72],
            'Yoel A4 ' : [44,35,85,37,41,53,72,86,49,79],
